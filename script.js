...
if (statusText) {
  const SPLASH_TEXTS = [
    ...
    "i make useless projects",
    "yes, i wrote this myself",
    "matrix",
    "still not done with this site",
    "git",
    "works on my machine",
    "welcome to the wrost website ever",
    "now in colour!!!1",
    "Call me jack the way i've bean stalking you",
    "posture check",
    "/watch?v=B05KyAyAa4k",
    "i want to rip my laptop in half when i download an webp",
    "unfortunately most of this website's effort goes into these splash texts",
    "wdym a website can fully break because of a missing comma",
    "confetti",
  ];
